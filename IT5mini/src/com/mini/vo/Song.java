...
public class Song {
	...
	public Song(int song_id, String song_name, int main_sid, String sub_sid, String release_date, String writer,
			String composer, double counting_star, int star_counter, String lyrics, int hits) {
		super();
	...
	public double getCounting_star() {
		return counting_star;
	}

	public void setCounting_star(double counting_star) {
		this.counting_star = counting_star;
	}
