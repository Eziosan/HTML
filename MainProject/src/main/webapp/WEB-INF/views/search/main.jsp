		...
		<section id="결과창">
			...
			<div class="곡결과 " id="곡결과">
				...
				<button class="carousel-control-prev" type="button"
					...
					<!-- count 변수 -->
					<c:set var="songCount" value="${searchResult1.size() }"/>
				...
				<div id="곡결과s" class="carousel slide" data-bs-ride="carousel"
					...
					<div class="carousel-item">
						<div class="row row-cols-sm-3 row-cols-lg-5">
							<!--          row-cols-1  row-cols-sm-2 row-cols-md-3 g-3 -->
							<!-- 6~10 곡 프로필-->
							<c:forEach var="song" items="${searchResult1 }" begin="5" end="9">
								<div class="col">
									<div class="card border border-white">
										<img src="${song.album_img} " alt="img" width="100%"
											height="225">
					...
					<div class="carousel-item">
						<div class="row row-cols-sm-3 row-cols-lg-5">
							<!--          row-cols-1  row-cols-sm-2 row-cols-md-3 g-3 -->
							<!-- 6~10 곡 프로필-->
							<c:forEach var="song" items="${searchResult1 }" begin="10"
								end="14">
								<div class="col">
									<div class="card border border-white">
										<img src="${song.album_img} " alt="img" width="100%"
				...
				<div id="앨범결과s" class="carousel slide" data-bs-ride="carousel"
					...
					<div class="carousel-item active">
						<div class="row row-cols-sm-3 row-cols-lg-5">
							<!--          row-cols-1  row-cols-sm-2 row-cols-md-3 g-3 -->
							<!-- 1~5 곡 프로필-->
							<c:forEach var="song" items="${searchResult2 }" begin="0" end="4">
								<div class="col">
									<div class="card border border-white">
										<img src="${song.album_img} " alt="img" width="100%"
											height="225">
					...
					<div class="carousel-item">
						<div class="row row-cols-sm-3 row-cols-lg-5">
							<!--          row-cols-1  row-cols-sm-2 row-cols-md-3 g-3 -->
							<!-- 6~10 곡 프로필-->
							<c:forEach var="song" items="${searchResult2 }" begin="5" end="9">
								<div class="col">
									<div class="card border border-white">
										<img src="${song.album_img} " alt="img" width="100%"
											height="225">
