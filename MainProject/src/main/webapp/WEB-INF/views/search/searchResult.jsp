			...
			<c:if test="${user_id != null }">
				<div class="dropdown text-end">
					...
					<a href="#"
						...
						<img src="../resources/img/profile2.jpg" alt="mdo" width="32"
					...
					<ul class="dropdown-menu text-small"
						...
						<li><a class="dropdown-item"
							href="logout?searchText=${searchText }">Sign out</a></li>
		...
		<c:choose>
			...
			<c:otherwise>
							...
							<c:forEach var="song" items="${searchResult1 }"
								...
								<div class="col">
									<div class="card border border-white">
										<a
											href="/mylife/song/songPage?song_id=${song.song_id }&singer_id=${song.singer_id}">
										...
										<div class="card1 mt-3 "
											...
											<p class="card-text mb-1 fw-bold"
												style="font-size: 23px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">
												<a
													href="/mylife/song/songPage?song_id=${song.song_id }&singer_id=${song.singer_id}"
													id="메인곡명">${song.song_name}</a>
											</p>
				...
				<button class="carousel-control-next" type="button"
					...
					<img src="../resources/img/오2.png" width="30px"> <span
			...
			<c:otherwise>
				...
				<div class="앨범결과 " id="곡결과" style="border-bottom: none;">
					...
					<button class="carousel-control-prev" id="앨범결과좌" type="button"
						...
						style="position: relative; top: 270px; left: 0px; right: 0px;">
						<img src="../resources/img/왼2.png"
							style="width: 30px; position: relative; right: 113px;"> <span
									...
									<div class="card border border-white">
										...
										<div class="card1 mt-3 "
											...
											<span class="card-text mb-0"
												...
												style="font-size: 13px; margin-left: 2px"> • </span> <span
												class="card-text mb-0"
												style="font-size: 13px; margin-left: 2px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">
												${song.album_name } </span>
											<!-- 
												<p class="card-text mb-0 text-danger"
													style="font-size: 13px; margin-left: 1px">예상 ★2.4</p>
					...
					<button class="carousel-control-next" id="앨범결과좌" type="button"
						data-bs-target="#앨범결과s" data-bs-slide="next"
						style="float: right; position: relative; top: -160px; left: 80px;">
