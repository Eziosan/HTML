...
<!--                평가 칸-->
    ...
    <div class="container" id="분석큰칸">
            <div id="태그큰칸">
                ...
                <div id="태그큰칸2">
                    <div id="태그칸">
                    	<c:forEach var="tagName" items="${tagNameList }" varStatus="status">
	                        <c:choose>
	                        	<c:when test="${status.count > 0 && status.count <= 3}">
			                        <span id="큰태그${status.count}">${tagName} ${status.count}</span>
	                        	</c:when>
	                        	<c:when test="${status.count > 3}">
			                        <span id="작은태그${status.count-3 }">${tagName} ${status.count-3 }</span>
	                        	</c:when>
	                        	<c:otherwise>
	                        	</c:otherwise>
	                        </c:choose>
...
-->
                    ...
                    <div id="가수큰칸2">
                        ...
                        <div id="캐러셀한칸">
                        	<c:forEach var="singer" items="${singerList}">
	                            <div class="row row-cols-2" id="가수한칸">
	                                <div class="col-2" id="가수프로필칸">
	                                    사진
	                                </div>
	                                <div class="col-8" id="가수정보란">
	                                    ${singer.singer_name}
	                                </div>
	                            </div>
	                            <br>
        ...
        <div id="국가큰칸">
            ...
            <div id="국가큰칸2">
                <div id="국가칸">
                    <div id="국가탑">
                    	<c:forEach var="countryLog" items="${countryLogList}" begin="0" end="2">
	                        <div id="국가탑1">
	                            <div id="국가탑나라">
	                                ${countryLog.country }
	                            </div>
	                            <div id="국가탑정보">
	                            	${countryLog.all_star }점 •  ${countryLog.grade_count }곡
	                            </div>
	                        </div>
                    ...
                    <ul id="국가밑큰">
                    	<c:forEach var="countryLog" items="${countryLogList}" begin="3" end="5">
	                        <li id="국가밑작">
	                            ${countryLog.country }프랑스(국가)
	                            <span id="국밑내용">
	                                ${countryLog.all_star }점 • ${countryLog.grade_count }곡
	                            </span>
	                        </li>
        ...
        <div id="국가큰칸">
            ...
            <div id="국가큰칸2">
                ...
                <div id="국가칸">
                    <div id="국가탑">
                    	<c:forEach var="genreLog" items="${genreLogList}" begin="0" end="2">
	                        <div id="국가탑1">
	                            <div id="국가탑나라">
	                               	${genreLog.genre }
	                            </div>
	                            <div id="국가탑정보">
	                                ${genreLog.all_star }점 • ${genreLog.grade_count}곡
	                            </div>
	                        </div>
                    	</c:forEach>
                    ...
                    <ul id="국가밑큰">
                    	<c:forEach var="genreLog" items="${genreLogList}" begin="3" end="5">
	                        <li id="국가밑작">
	                           	${genreLog.genre }
	                            <span id="국밑내용">
	                                ${genreLog.all_star }점 • ${genreLog.grade_count}곡
